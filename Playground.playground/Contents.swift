...
let rui = Player(name: "Rui",           skills: [4.6,  4.6,   4.8,    4.3] |> toSkill)
let jack = Player(name: "Jack",         skills: [4.6,  4.5,   4.5,    4.5] |> toSkill)
...
let joaoG = Player(name: "Joao G.",     skills: [3.4,  2.9,   3.5,    2.7] |> toSkill)
...
let barney = Player(name: "Barney",     skills: [4.6,  4.4,   4.6,    4.5] |> toSkill)
let ozan = Player(name: "Ozan",         skills: [2.5,  2.5,   2.5,    2.5] |> toSkill)
